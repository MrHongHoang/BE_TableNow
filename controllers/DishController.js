...
const createDish = async (req, res) => {
  try {
    const { dishName, dishType, dishDescribe, dishImage, dishQuantity, dishPrice, dishDiscount } = req.body;
    
    if (!dishName || !dishType || !dishDescribe || !dishImage || !dishQuantity || !dishPrice|| !dishDiscount) {
